document.addEventListener("DOMContentLoaded", function () {
    ...
    var defaultContent = document.querySelector('#popularupcomingreleases');
    var defaultMenu = document.querySelector('.nama-nav-end a[href="#popularupcomingreleases"]').parentElement;
